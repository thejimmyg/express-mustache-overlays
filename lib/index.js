...
const overlaysOptionsFromEnv = () => {
  ...
  return { scriptName, publicUrlPath, withPjaxPwa, networkErrorUrl, manifestUrl, serviceWorkerUrl, icon192Url, themeColor }
}
...
const prepareMustacheOverlays = async (app, options) => {
  ...
  const self = {
    mustacheDirs: [],
    publicFilesDirs: [],
    locals: { publicUrlPath, publicURLPath: publicUrlPath, expressStaticOptions, manifestUrl, serviceWorkerUrl, icon192Url, networkErrorUrl, withPjaxPwa, title, themeColor, scriptName },
