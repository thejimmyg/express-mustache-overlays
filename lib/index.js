...
const prepareMustacheOverlays = async (app, options) => {
  ...
  const { expressStaticOptions, withPjaxPwa = false, title = 'Express Mustache Overlays', scriptName = '', ...scriptNameDependent } = options || {}
  ...
  app.locals = Object.assign({}, app.locals, { publicURLPath, withPjaxPwa, scriptName, title })
